...
const { isExporting, exportUnitConversionToTxt, exportUnitConversionToPdf, exportUnitConversionToExcel, printUnitConversion } = useExport();
...
// Handle export Excel
// modify by jx: add Excel export handler for unit conversion questions
const handleExportExcel = (includeAnswers: boolean) => {
  ...
  try {
    exportUnitConversionToExcel(questions.value, includeAnswers);
  } catch (error) {
