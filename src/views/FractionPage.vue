...
const { isExporting, exportFractionsToTxt, exportFractionsToPdf, exportFractionsToExcel, printFractions } = useExport();
...
const handleExportTxt = (includeAnswers: boolean) => {
  ...
  try {
    exportFractionsToTxt(questions.value, includeAnswers);
  } catch (error) {
...
const handleExportPdf = (includeAnswers: boolean) => {
  ...
  try {
    exportFractionsToPdf(questions.value, includeAnswers);
  } catch (error) {
...
// Handle export Excel
// modify by jx: add Excel export handler for fraction questions
const handleExportExcel = (includeAnswers: boolean) => {
  ...
  try {
    exportFractionsToExcel(questions.value, includeAnswers);
  } catch (error) {
...
const handlePrint = (includeAnswers: boolean) => {
  ...
  try {
    printFractions(questions.value, includeAnswers);
  } catch (error) {
