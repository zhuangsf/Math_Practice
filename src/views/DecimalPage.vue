...
const { isExporting, exportDecimalsToTxt, exportDecimalsToPdf, exportDecimalsToExcel, printDecimals } = useExport();
...
// Handle export Excel
// modify by jx: add Excel export handler for decimal questions
const handleExportExcel = (includeAnswers: boolean) => {
  ...
  try {
    exportDecimalsToExcel(questions.value, includeAnswers);
  } catch (error) {
