...
// modify by jx: implement factor multiple tutoring plan component showing personalized learning suggestions

import type { FactorMultipleTutoringPlan } from '@/types';

// Define props
defineProps<{
  plan: FactorMultipleTutoringPlan | null;
}>();
...
const formatQuestionTypes = (types: ('find-multiples' | 'find-factors' | 'gcd' | 'lcm')[]): string => {
