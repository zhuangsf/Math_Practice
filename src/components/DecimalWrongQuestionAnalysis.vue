...
// modify by jx: implement decimal wrong question analysis component showing statistics and categorization

import type { DecimalWrongQuestionStats, DecimalWrongQuestion } from '@/types';

// Define props
defineProps<{
  stats: DecimalWrongQuestionStats | null;
