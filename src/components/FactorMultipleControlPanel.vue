  ...
  <div class="control-panel">
    ...
    <div class="control-section">
      ...
      <el-checkbox-group v-model="config.questionTypes" size="large">
        <el-checkbox-button value="find-multiples">找倍数</el-checkbox-button>
        <el-checkbox-button value="find-factors">找因数</el-checkbox-button>
        <el-checkbox-button value="gcd">最大公因数</el-checkbox-button>
        <el-checkbox-button value="lcm">最小公倍数</el-checkbox-button>
      </el-checkbox-group>
