  ...
  <div class="control-panel">
    ...
    <div class="control-section">
      ...
      <el-checkbox-group v-model="config.questionTypes" size="large">
        <el-checkbox-button label="find-multiples">找倍数</el-checkbox-button>
        <el-checkbox-button label="find-factors">找因数</el-checkbox-button>
        <el-checkbox-button label="gcd">最大公因数</el-checkbox-button>
        <el-checkbox-button label="lcm">最小公倍数</el-checkbox-button>
      </el-checkbox-group>
    ...
    <!-- Multiple Count -->
    <div class="control-section">
      <h3 class="section-title">倍数数量</h3>
      <el-input-number
        v-model="config.multipleCount"
        :min="3"
        :max="10"
        :step="1"
        controls-position="right"
...
// modify by jx: implement factor multiple control panel component for user configuration

import { reactive, ref, watch } from 'vue';
import type { FactorMultipleConfig, AnswerMode } from '@/types';

// Define props and emits
const props = defineProps<{
  modelValue: FactorMultipleConfig;
  showAnswers: boolean;
  answerMode: AnswerMode;
}>();

const emit = defineEmits<{
  'update:modelValue': [value: FactorMultipleConfig];
  'update:showAnswers': [value: boolean];
  'update:answerMode': [value: AnswerMode];
}>();

// Local reactive config
const config = reactive<FactorMultipleConfig>({ ...props.modelValue });
