...
// modify by jx: implement decimal tutoring plan component showing personalized learning suggestions

import type { DecimalTutoringPlan, OperationType } from '@/types';
import { getOperationTypeName } from '@/composables/useWrongQuestionAnalysis';

// Define props
defineProps<{
  plan: DecimalTutoringPlan | null;
}>();
