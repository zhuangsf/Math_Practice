...
// modify by jx: implement comparison tutoring plan component showing personalized learning suggestions

import type { ComparisonTutoringPlan } from '@/types';

// Define props
defineProps<{
  plan: ComparisonTutoringPlan | null;
}>();
...
const formatQuestionTypes = (types: ('integer' | 'decimal' | 'fraction' | 'decimal-fraction')[]): string => {
  const nameMap: Record<string, string> = {
    'integer': '整数比较',
    'decimal': '小数比较',
    'fraction': '分数比较',
    'decimal-fraction': '小数分数混合比较'
  };
