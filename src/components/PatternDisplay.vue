...
// modify by jx: implement pattern question display component with 4-column layout and answering mode support

import { computed, ref, watch } from 'vue';
import type { PatternQuestion, AnswerStatus } from '@/types';
...
const columns = computed(() => {
  const cols: (PatternQuestion & { index: number })[][] = [[], [], [], []];
