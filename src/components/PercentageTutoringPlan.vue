...
// modify by jx: implement percentage tutoring plan component showing personalized learning suggestions

import type { PercentageTutoringPlan } from '@/types';

// Define props
defineProps<{
  plan: PercentageTutoringPlan | null;
}>();
...
const formatQuestionTypes = (types: ('decimal-to-percent' | 'percent-to-decimal' | 'fraction-to-percent' | 'percent-to-fraction' | 'find-percent' | 'find-part' | 'find-total')[]): string => {
