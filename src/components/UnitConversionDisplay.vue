...
// modify by jx: implement unit conversion question display component with 4-column layout and answering mode support

import { computed, ref, watch } from 'vue';
import type { UnitConversionQuestion, AnswerStatus } from '@/types';
...
const columns = computed(() => {
  const cols: (UnitConversionQuestion & { index: number })[][] = [[], [], [], []];
