<template>
  <div class="control-panel">
    ...
    <!-- Decimal Places -->
    <div class="control-section">
      <h3 class="section-title">小数位数（仅小数比较）</h3>
      <el-input-number
    ...
    <!-- Max Denominator -->
    <div class="control-section">
      <h3 class="section-title">最大分母（仅分数比较）</h3>
      <el-input-number
        v-model="config.maxDenominator"
        :min="5"
        :max="20"
        :step="1"
        controls-position="right"
...
// modify by jx: implement comparison control panel component for user configuration

import { reactive, ref, watch } from 'vue';
import type { ComparisonConfig, AnswerMode } from '@/types';
...
const config = reactive<ComparisonConfig>({ ...props.modelValue });
