  ...
  <div class="control-panel">
    ...
    <div class="control-section">
      ...
      <el-checkbox-group v-model="config.questionTypes" size="large">
        <el-checkbox-button value="decimal-to-percent">小数转百分数</el-checkbox-button>
        <el-checkbox-button value="percent-to-decimal">百分数转小数</el-checkbox-button>
        <el-checkbox-button value="fraction-to-percent">分数转百分数</el-checkbox-button>
        <el-checkbox-button value="percent-to-fraction">百分数转分数</el-checkbox-button>
        <el-checkbox-button value="find-percent">求百分数</el-checkbox-button>
        <el-checkbox-button value="find-part">求部分</el-checkbox-button>
        <el-checkbox-button value="find-total">求总数</el-checkbox-button>
      </el-checkbox-group>
    ...
    <div class="control-section">
      ...
      <div class="range-inputs">
        <div class="range-input">
          ...
          <el-input-number
            v-model="config.valueRange[0]"
            :min="1"
            :max="config.valueRange[1] - 1"
            :step="1"
        ...
        <div class="range-input">
          ...
          <el-input-number
            v-model="config.valueRange[1]"
            :min="config.valueRange[0] + 1"
            :max="100"
            :step="1"
            controls-position="right"
          />
...
// modify by jx: implement percentage control panel component for user configuration

import { reactive, ref, watch } from 'vue';
import type { PercentageConfig, AnswerMode } from '@/types';

// Define props and emits
const props = defineProps<{
  modelValue: PercentageConfig;
  showAnswers: boolean;
  answerMode: AnswerMode;
}>();

const emit = defineEmits<{
  'update:modelValue': [value: PercentageConfig];
  'update:showAnswers': [value: boolean];
  'update:answerMode': [value: AnswerMode];
}>();

// Local reactive config
const config = reactive<PercentageConfig>({ ...props.modelValue });
