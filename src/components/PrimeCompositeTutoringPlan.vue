...
// modify by jx: implement prime composite tutoring plan component showing personalized learning suggestions

import type { PrimeCompositeTutoringPlan } from '@/types';

// Define props
defineProps<{
  plan: PrimeCompositeTutoringPlan | null;
}>();
...
const formatQuestionTypes = (types: ('is-prime' | 'is-composite' | 'prime-factors')[]): string => {
