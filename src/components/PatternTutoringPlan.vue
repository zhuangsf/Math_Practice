      ...
      <div class="plan-content">
        ...
        <div v-if="plan.recommendedConfig" class="recommendation-section">
          ...
          <div class="recommended-config">
            <div v-if="plan.recommendedConfig.patternTypes" class="config-item">
              <span class="config-label">规律类型：</span>
              <span class="config-value">
                {{ formatPatternTypes(plan.recommendedConfig.patternTypes) }}
              </span>
            </div>
...
// modify by jx: implement pattern tutoring plan component showing personalized learning suggestions

import type { PatternTutoringPlan } from '@/types';

// Define props
defineProps<{
  plan: PatternTutoringPlan | null;
}>();
...
// Format pattern types array to display string
const formatPatternTypes = (types: ('arithmetic' | 'geometric' | 'fibonacci' | 'square' | 'cube')[]): string => {
